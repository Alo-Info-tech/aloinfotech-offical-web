...
.contentheading {
    ...
    select {
        ...
        border: white;
        border-bottom: 1px solid #82c4e7;
    }
...
-ms-background-size: cover !important; */
    ...
    .body1 {
        ...
        animation: Home_banner_rotation__w6cTS 12s linear infinite;
...
.formbg{
 background: url(assets/images/ico.png) ;
  ...
  width: 200px;
  height: 200px;
   background: url(assets/images/globeuse.webp) ;
  background-repeat:  no-repeat;
  background-size: auto 100%;
  animation: play 4s steps(16) infinite; right: 0;
    position: absolute;
} */
    .globe {
...
.bgform{
    background: url(assets/images/ico.png) no-repeat center;
}
...
h2.contentheading.mb-2.text-center.fw-bolder.pb-2 {
    margin-top: 32px;
}
.contactclass.text-center.p-3 {
...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <h2 class="contentheading text-center mb-2 mt-4 fw-bolder">Our <span class="heading">Location</span></h2>



    <section class="py-1 mt-2 ">
        <div class="globe text-center">
            <img src="assets/images/globeuse.webp">
        </div>
        ...
        <div class="container py-md-2 py-1">
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-lg-3 about-2-secs-left">
                    <div class="col-md-3 col-lg-6 col-xl-6  mb-4 footerres wid">
                        ...
                        <h3> <span class="heading pb-2">Nagercoil</span></h3>
                        <p class="lh"><span class="ps-1 "><a href="https://goo.gl/maps/1nEptGMzufcwXoTc6" class="text-dark"> Chettikulam
                                Junction, Hindu College Road,
                                Chetti Kulam, Chenthooran Nagar, Nagercoil-1.</a></span>
                        </p>

                        <p><span> +(91)
                                <a style="color:black" href="tel:7395850903"> 7395850903</a> </span></p>
                        <p><span> <a style="color:black"
                                    href="mailto:contact@alogroups.com">contact@alogroups.com</a></span></p>
                        <p>
                        <ul class="d-flex ps-4">
                            <li class="d-flex me-2"><a href=" https://www.facebook.com/Alo-Info-tech-102973818870997/" ><i class="fa-brands fa-facebook-official"></i><a></a></li>

                            <li class="d-flex"><a href=" https://instagram.com/alo_infotech?utm_medium=copy_link" > <i class="fa-brands fa-square-instagram"></i><a></a></li>
                            <li class="d-flex mx-2"><a href="https://www.linkedin.com/company/alo-info-tech" ><i class="fa-brands fa-linkedin"></i></a></li>
                        </ul>
                        </p>
...
<!-- 
                        ...
                        <h3 > <span class="heading pb-2">Chennai</span></h3>
                        <p class="lh"><span class="ps-1">No 4 &
                                5, Ramakrishna Nagar, Mariyammal Nagar main road, Kavangarai east, Chennai.</span>
                        </p>

                        <p> <span> +(91)
                                <a style="color:black" href="tel:7395850903"> 739-585-0903</a> </span></p>
                        <p><span> <a style="color:black"
                                    href="mailto:contact@alogroups.com">contact@alogroups.com</a></span></p>
                        <p>
                        <ul class="d-flex ps-4">
                ...
                <div class="col-lg-6 about-2-secs-right mt-lg-0 mt-3 ">
                    <!-- <img src="assets\images\map-1.png" alt="" class="img-fluid" /> -->
                    <!-- <div class="col-md-6 col-lg-6 col-xl-6  mb-4 footerres wid ">
                        ...
                        <div class="d-flex icontext">
                            ...
                            <div class="cont-right globe">


                            </div>

                        </div>
                        <p><i class="fa fa-envelope cont-right" aria-hidden="true"></i><span class="ps-1">No 4 &
                                5,Ramakrishna Nagar,Mariyammal Nagar main road,Kavangarai east,Chennai,TamilNadu
                                600066.</span>
                        </p>
                        <p><i class="fa fa-phone cont-right" aria-hidden="true"></i> Call Us</span><span> +(91)
                                <a style="color:black" href="tel:+7395850903"> 739-585-0903</a> </span></p>
                        <p><i class="fa fa-envelope cont-right" aria-hidden="true"></i> <span class="ps-1">Email
                                Us</span><span> <a style="color:black"
                                    href="mailto:contact@alogroups.com">contact@alogroups.com</a></span></p>
                        <p>
                        <ul class="d-flex ps-4">
                ...
                <img src="assets\images\mapp1.png" alt="" class="img" />
            </div>
        </div>
  ...
  ------------------------------------------------------------>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 563" fill="none">
            <g id="Image">
                    ...
                    <!-- <img src="assets\images\contact1.webp" alt="" class="img-fluid" /> -->
                </div>
                <div class="col-lg-6 bgform" >
                    <h2 class="contentheading  mb-2 text-center fw-bolder pb-2">Get In Touch <span class="heading">With Us</span></h2>
                    <!-- <div class="card shadow-inner contactcard  ">  -->
                        <div class="contactclass text-center p-3" >
                            <form name="RegForm" method="POST" action="email.php" autocomplete="off" enctype="multipart/form-data" style="animation: none;" >
                                <input class="fname inppad" type="text" name="name"  placeholder="Full name*" id="name"
                        onblur="date()" onkeypress="names()" required onkeydown="return /[a-z]/i.test(event.key)"/><br>
                                <div id="formname"></div>
                                <input class="inppad" type="email " name="email" placeholder="E-mail*" required onblur="validate()" onkeypress="emails()" id="Email" /><br>
                                <div id="formmail"></div>
                                <input class="inppad" id="message" type="text" name="message" placeholder="Type Your Message Here*" required onblur="clock()" onkeypress="messages()">
                                <div id="formmessage"></div>
                            
                            <div class="p-2 button1 pt-4">
                                <button type="submit" name="submit" class="btn btn-primary border1" >Send
                                    message</button>
                            </div>
                        </form>
    ...
    function date()
            {
              ...
              if(name==="")
                {
                    document.getElementById("formname").innerHTML="Please enter your name";
       ...
       function validate()
            {
              ...
              var Email = document.getElementById("Email").value;
                ...
                if(Email==="")
                {
                  document.getElementById("formmail").innerHTML="Please enter your email address";
                 ...
                 else
                {
                    ...
                    document.getElementById("formmail").innerHTML="Enter the valid email address";
                    document.getElementById("formmail").style.color="Red";
...
function clock()
            {
              ...
              if(message==="")
                {
                    document.getElementById("formmessage").innerHTML="Please enter your message";
