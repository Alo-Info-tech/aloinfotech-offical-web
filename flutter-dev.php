    ...
    <section class="py-1 mt-2">
        ...
        <div class="container ">
            <div class="row text-center mt-5">
                <div class="col-md-6">
                    <h3 class="text-center careerheading">Flutter Developer</h3>
                    <img src="assets\images\flutter-career.png" class="img-fluid mt-5" alt="flutter">
                    <p class="quatation mt-3">We are looking for Flutter Developer who can create multi-platform apps for iOS and Android using Flutter development framework..</p>
                </div>

                <div class="col-md-6 mb-5">
                    <h3 class="contentheading mb-2 text-center">DROP YOUR <span class="heading">INFORMATION</span></h3>
                        ...
                        <div class="contactclass text-center p-3">
                            <form name="RegForm" method="POST" autocomplete="off" action="developers.php" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="Select" class="form-select mt-2" name="Applyforpost" placeholder="Applyforpost	">
                                        <option>Apply For Post</option>
                                        <option>Flutter Developer</option>
                                        <div id="errapply your post" style="padding: 0px 19px 0px;color:red;"></div>
                                    </select>
                                </div>
                                <div class="mb-3">
    ...
    <script>
        function validate() {
            ...
            if (Email === "") {
                ...
                document.getElementById("errmail").innerHTML = "Enter the valid email address";
                document.getElementById("errmail").style.color = "Red";
