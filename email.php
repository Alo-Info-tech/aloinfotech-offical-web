...
if (!empty($name) && !empty($email) && !empty($message)) {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL) === false) {
        ...
        if (!empty($_FILES['file']['name'])) {
            ...
            $allowTypes = array('pdf', 'doc', 'docx', 'jpg', 'png', 'jpeg', 'PNG');
        ...
        if ($uploadStatus == 1) {
            ...
            // Recipient
            $toEmail = 'arokiaanialogroups@gmail.com';
            ...
            if ($mail) {
                ...
                echo "<script>window.location.href='aloinfotech/contactus.php?success=1'</script>";
...
<!-- 
         ...
         if( $retval == true ) {
             header("Location:http://aloinfotech/contactus");
           echo "Submitted";
