...
<head>
  ...
  <script nonce="1b4a9356-0c6c-496f-90fd-2944240f52b2">
    (function(w, d) {
      ! function(a, e, t, r, z) {
        ...
        s && (a.zarazData.t = e.getElementsByTagName("title")[0].text), a.zarazData.w = a.screen.width, a.zarazData.h = a.screen.height, a.zarazData.j = a.innerHeight, a.zarazData.e = a.innerWidth, a.zarazData.l = a.location.href, a.zarazData.r = e.referrer, a.zarazData.k = a.screen.colorDepth, a.zarazData.n = e.characterSet, a.zarazData.o = (new Date).getTimezoneOffset(), a.dataLayer = a.dataLayer || [], a.zaraz.track = (e, t) => {
          ...
          var t = e.getElementsByTagName(r)[0],
            z = e.createElement(r);
          z.defer = !0, z.src = "assets/js/sd0d9.js?z=" + btoa(encodeURIComponent(JSON.stringify(a.zarazData))), t.parentNode.insertBefore(z, t)
        }))
      }(w, d, 0, "script");
    })(window, document);
  </script>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Alo Groups</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          ?>
            <div class="info">
              <a href="#" class="d-block"><?php echo $OTP; ?></a>
            </div>
          <?php
          }
          ?>
