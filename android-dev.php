...
<body>
    ...
    <div class="row text-center mt-5">
        <div class="col-md-6">
            <h3 class="text-center careerheading">Android Developer</h3>
            <img src="assets\images\android-career.jpg" class="img-fluid mt-5" alt="flutter">
            <p class="quatation mt-3">We are looking for Android Developer Design and build advanced applications for the Android platform and Collaborate with cross-functional teams to define, design, and ship new features Work with outside data sources and APIs Unit-test code for robustness, including edge cases, usability and general reliability Work on bug fixing to improving application performance.</p>
        </div>
       ...
       function validate()
            {
              ...
              var Email = document.getElementById("Email").value;
                ...
                if(Email==="")
                {
                  document.getElementById("errormail").innerHTML="Please enter your email address";
                 ...
                 else
                {
                    ...
                    document.getElementById("errormail").innerHTML="Enter the valid email address";
                    document.getElementById("errormail").style.color="Red";
...
function time()
            {
              ...
              if(number==="")
                {
                    document.getElementById("errornumber").innerHTML="Please enter your phone number";
