...
<body>
    ...
    <div class="row text-center mt-5">
        <div class="col-md-6">
            <h3 class="text-center careerheading">UI/UX Developer</h3>
            <img src="assets\images\ui-ux-career.png" class="img-fluid mt-5" alt="flutter">
            <p class="quatation mt-3">We are looking for UI/UX designer One who designs and delivers top-notch user experience and visually delightful, easy to use digital products in a fast paced environment. Our ideal candidate would work closely with developers, product managers, copywriters and other designers on projects ranging from Website to Digital Products.</p>
        </div>
       ...
       function validate()
            {
              ...
              var Email = document.getElementById("Email").value;
                 ...
                 else
                {
                    ...
                    document.getElementById("mailerror").innerHTML="Enter the valid email address";
                    document.getElementById("mailerror").style.color="Red";
...
function time()
            {
              ...
              if(number==="")
                {
                    document.getElementById("messageerror").innerHTML="Please enter your phone number";
