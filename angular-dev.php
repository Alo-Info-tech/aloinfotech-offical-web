...
<body>
    ...
    <div class="row text-center mt-5">
        <div class="col-md-6">
            <h3 class="text-center careerheading">Angular Developer</h3>
            <img src="assets\images\angular_career.png" class="img-fluid mt-5" alt="flutter">
            <p class="quatation mt-3">We are looking for Angular Developer who developing user interfaces using AngularJS best practices and adapting interface for modern internet applications using the latest front-end technologies with Writing JavaScript, CSS, and HTML. To Developing product analysis tasks with Developing application codes and unit tests in AngularJS, Java Technologies, and Rest Web Services.</span></li>
</p>
        </div>
      ...
      <select id="Select" class="form-select mt-2" name="Applyforpost" placeholder="Apply For post">
        ...
        <!-- <div id="errapply your post"></div> -->
      </select>
    </div>
    <div class="mb-3">
      
      <select id="Select" class="form-select mt-2" name="experience"  placeholder="Experience">
       ...
       function validate()
            {
              ...
              var Email = document.getElementById("Email").value;
                ...
                if(Email==="")
                {
                  document.getElementById("ermail").innerHTML="Please enter your email address";
                  document.getElementById("ermail").style.color="Red";
                }
                 ...
                 else
                {
                    ...
                    document.getElementById("ermail").innerHTML="Enter the valid email address";
                    document.getElementById("ermail").style.color="Red";
...
function time()
            {
              ...
              if(number==="")
                {
                    document.getElementById("ernumber").innerHTML="Please enter your phone number";
